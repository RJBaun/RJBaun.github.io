...
const AboutMe = () => {
  ...
  return (
    <div className='about-me'>
          <a id='about-me'>
            <h2>ABOUT ME</h2>
          <p className='about-me-intro'>Prior to taking the leap of faith into the world of programming, I have worked to establish an eclectic list of employment and 
          ...
          <p className='about-me-intro'>Below you can find a list of my most recent and significant undertakings.</p>
          </a>
