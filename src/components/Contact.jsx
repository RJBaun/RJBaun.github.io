  ...
  return (
    <section className='contact'>
      ...
      <form ref={form} onSubmit={sendEmail}>
        ...
        <p>Please be sure to include your contact informationin the message you submit.</p>
        <div className='inputs'>
          <input type='text' placeholder='Your Name' name='from_name' required />
        </div>
        <textarea className='textbox' placeholder='Your message here...' rows='5' cols='50' name='message' required />
